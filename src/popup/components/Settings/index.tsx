...
/** The settings menu panel; the gear that opens it lives in the Header. */
export const Settings = () => {
    const { Settings, updateSettings, menuOpen } = useSettings();
                        ...
                        <li>
                            ...
                            <div className={styles.row}>
                                <input
                                    ...
                                    min={0}
                                    step={50}
                                    value={Settings.albumDownload.recentLimit}
                                    onChange={(e) =>
                                        updateSettings({
                                            albumDownload: {
                        ...
                        <li>
                            ...
                            <div className={styles.row}>
                                <input
                                    ...
                                    min={0}
                                    step={50}
                                    value={Settings.albumDownload.startIndex}
                                    onChange={(e) =>
                                        updateSettings({
                                            albumDownload: {
                                                ...Settings.albumDownload,
                        ...
                        <li>
                            ...
                            <div className={styles.row}>
                                <input
                                    ...
                                    max={10}
                                    value={
                                        Settings.albumDownload.downloadQuantity
                                    }
                                    onChange={(e) =>
                                        updateSettings({
                                            albumDownload: {
                        ...
                        <li>
                            ...
                            <div className={styles.row}>
                                <input
                                    ...
                                    min={100}
                                    step={250}
                                    value={Settings.albumDownload.maxZipSizeMB}
                                    onChange={(e) =>
                                        updateSettings({
                                            albumDownload: {
                                                ...Settings.albumDownload,
                        ...
                        <li>
                            ...
                            <p
                                ...
                                Settings.chatDownload.rangeEnd > 0
                                    ? `Messages #${
                                          Settings.chatDownload.rangeStart || 1
                                      } to ${
                        ...
                        <li>
                            ...
                            <div className={styles.row}>
                                ...
                                <p
                                    ...
                                    {Settings.chatDownload.messagesPerFile > 0
                        ...
                        <li>
                            ...
                            <div className={styles.row}>
                                <input
                                    ...
                                    min={0}
                                    step={10}
                                    value={Settings.chatDownload.maxFileSizeMB}
                                    onChange={(e) =>
                                        updateSettings({
                                            chatDownload: {
                                                ...Settings.chatDownload,
